...
QChart {
    ...
    chartOptions: ({
        ...
        fillColor: [
            "rgba(190,133,255,0)", "rgba(190,133,255,0.3)", "rgba(190,133,255,0.3)",
            "rgba(120,84,161,0)", "rgba(120,84,161,0.2)", "rgba(120,84,161,0.2)"
        ],
        strokeColor: [
            "rgba(190,133,255,1)", "rgba(190,133,255,0)", "rgba(190,133,255,0)",
            "rgba(120,84,161,1)", "rgba(120,84,161,0)", "rgba(120,84,161,0)"
        ],
        pointColor: [
