...
# This project moved to [Codeberg](https://codeberg.org/ichthyosaurus/harbour-meteoswiss)

> [!WARNING]
> **Development of MeteoSwiss has moved to
> [Codeberg](https://codeberg.org/ichthyosaurus/harbour-meteoswiss).
> Please update your bookmarks and local clones to point to the new URL.**
>
>     git remote set-url origin https://codeberg.org/ichthyosaurus/harbour-meteoswiss
>     git fetch
...
<img src="https://codeberg.org/ichthyosaurus/sailfish-app-assets/raw/branch/main/harbour-meteoswiss/banner-small.png"
     alt="MeteoSwiss banner" />

# MeteoSwiss for [Sailfish OS](https://sailfishos.org)
...
Unofficial client for Swiss weather forecasts
  ...
  <p>
    ...
    <a href="https://hosted.weblate.org/projects/harbour-meteoswiss/translations">
      <img src="https://hosted.weblate.org/widgets/harbour-meteoswiss/-/translations/svg-badge.svg"
           alt="Translations" />
    </a>
    <a href="https://codeberg.org/ichthyosaurus/harbour-meteoswiss">
      <img src="https://codeberg.org/ichthyosaurus/.profile/raw/branch/main/badges/development_%20stable.svg"
           alt="Development status" />
    </a>
    <a href="https://codeberg.org/ichthyosaurus/harbour-meteoswiss/src/branch/main/LICENSES">
    ...
    <a href="https://api.reuse.software/info/codeberg.org/ichthyosaurus/harbour-meteoswiss">
      <img src="https://api.reuse.software/badge/codeberg.org/ichthyosaurus/harbour-meteoswiss"
           alt="REUSE status" />
    </a>
    <br />
...
> You can find screenshots [here](https://codeberg.org/ichthyosaurus/sailfish-app-assets/src/branch/main/harbour-meteoswiss/screenshots-store).


## Permissions

MeteoSwiss requires the following
[Sailjail](https://github.com/sailfishos/sailjail-permissions?tab=readme-ov-file#permissions) permissions:

- `Internet`: to download weather forecasts
...
[![Translations status](https://hosted.weblate.org/widget/harbour-meteoswiss/horizontal-auto.svg)](https://hosted.weblate.org/engage/harbour-meteoswiss/)

Translations are managed using
[Weblate](https://hosted.weblate.org/projects/harbour-meteoswiss).
Please prefer this over pull requests (which are still welcome, of course).
If you just found a minor problem, you can also
[open an issue](https://codeberg.org/ichthyosaurus/harbour-meteoswiss/issues/new).
...
1. Clone the repository by running `git clone --recursive https://codeberg.org/ichthyosaurus/harbour-meteoswiss`
2. Open `harbour-meteoswiss.pro` in QtCreator for Sailfish ([SailfishOS SDK](https://docs.sailfishos.org/Tools/Sailfish_SDK/))
...
> Copyright (C) 2018-2026  Mirian Margiani
...
The source code is available [on Codeberg](https://codeberg.org/ichthyosaurus/harbour-meteoswiss).
All documentation is released under the terms of the
[GNU Free Documentation License v1.3 (or later)](https://spdx.org/licenses/GFDL-1.3-or-later.html).

MeteoSwiss and related materials must not be used for AI training and/or data mining.

This project follows the [REUSE specification](https://api.reuse.software/info/codeberg.org/ichthyosaurus/harbour-meteoswiss).
